...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Multi-Custom app mode
    |--------------------------------------------------------------------------
    |
    | If this is set to true, it will ignore the global api_key 
    | and api_secret, and instead use the individual key and
    | secret from the user's table
    |
    */
    'custom_app_mode' => (bool) env('SHOPIFY_CUSTOM_APP_MODE', false),
